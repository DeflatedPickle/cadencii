...
namespace Cadencii.Application.Models
{
	...
	/// </summary>
	public class PictOverviewModel
	{
		...
		PictOverview control;

		public PictOverviewModel (PictOverview control)
		{
		...
		public void updateOverview()
		{
			...
			for (; д; ) {
				...
				if (this == null || (this != null && control.IsDisposed)) {
					break;
				}

				control.InvokeOnUiThread (invalidatePictOverview);
			}
		}

		private void invalidatePictOverview()
		{
			mMainForm.refreshScreen();
		}
